# @milludds/ckeditor5-full-free-build-and-emojis

CKEditor5 build including all available free features and emojis.
This repository presents a CKEditor 5 editor build generated by the [Online builder tool](https://ckeditor.com/ckeditor-5/online-builder).
Emoji plugin created by @phudak/ckeditor5-emoji. It uses a modified version of the ckeditor5 SpecialCharacters plugin.

## Required packages

Run `yarn add @ckeditor/ckeditor5-react` before installing the library.

## Install NPM package

Run `yarn add @milludds/ckeditor5-full-free-build-and-emojis` in your project.
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `o8dlwbogpp3v-b50w7y4jiro6`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
